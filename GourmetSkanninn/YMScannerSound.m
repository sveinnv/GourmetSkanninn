...

{
	...
	YMScannerSound *viewController =
	(__bridge YMScannerSound *)inRefCon;
...
{
	YMScannerSound *viewController =
	(__bridge YMScannerSound *)inClientData;
